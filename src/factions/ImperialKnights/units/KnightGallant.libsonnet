      ...
      "other": [
        {
          ...
          "body": "While a model is affected by this ability, you can re-roll Charge rolls made for that model and each time that model makes a melee attack, you can re-roll the Hit roll."
        },
        {
          "name": "Martial Pride",
          "body": "Each time a melee attack targets this model, subtract 1 from the Hit roll."
        },
        {
